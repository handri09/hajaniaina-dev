...
function Footer() {
  return (
    <footer className="w-full text-center bg-violet-700 text-white">
      ...
      <div className='w-full bg-violet-900'>
        <div className="w-full max-w-screen-lg mx-auto text-center p-4 bg-violet-900">
          © 2022 Copyright:
          <a className="text-whitehite" href="https://tailwind-elements.com/"> Hajaniaina-Dev</a>
        </div>
      </div>
    </footer>
  );
