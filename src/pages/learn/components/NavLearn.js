      ...
      <div className={`w-full flex justify-center items-center`}>
        ...
        <form className={`w-full max-w-screen-lg mx-auto px-2 p-1`}>   
          ...
          <div className='relative'>
            ...
            <input type='search' id='default-search' className='block p-2 pl-10 w-full text-md text-gray-900 bg-violet-200 rounded-lg border border-gray-300 focus:ring-violet-500 focus:border-violet-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-violet-500 dark:focus:border-violet-500' placeholder='Search ...' />
            <button type='submit' className='text-white absolute right-2.5 bottom-2 bg-violet-700 hover:bg-violet-800 focus:ring-4 focus:outline-none focus:ring-violet-300 font-medium rounded-lg text-sm px-4 py-1 dark:bg-violet-600 dark:hover:bg-violet-700 dark:focus:ring-violet-800'>Search</button>
          </div>
        </form>
